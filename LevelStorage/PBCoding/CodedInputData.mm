...
CodedInputData::CodedInputData(NSData* oData)
	: bufferPointer((uint8_t*)oData.bytes), bufferSize(static_cast<int32_t>(oData.length)), bufferSizeAfterLimit(0), bufferPos(0), lastTag(0), currentLimit(INT_MAX), recursionDepth(0), recursionLimit(DEFAULT_RECURSION_LIMIT), sizeLimit(DEFAULT_SIZE_LIMIT)
{
}
...
int32_t CodedInputData::readTag() {
	if (this->isAtEnd()) {
		lastTag = 0;
		return 0;
	}
...
void CodedInputData::checkLastTagWas(int32_t value) {
	if (lastTag != value) {
...
int64_t CodedInputData::readFixed64() {
 ...
 */
int32_t CodedInputData::readEnum() {
	return this->readRawVarint32();
}


/** Read an {@code sfixed32} field value from the stream. */
int32_t CodedInputData::readSFixed32() {
	return this->readRawLittleEndian32();
}


/** Read an {@code sfixed64} field value from the stream. */
int64_t CodedInputData::readSFixed64() {
	return this->readRawLittleEndian64();
}


/** Read an {@code sint32} field value from the stream. */
int32_t CodedInputData::readSInt32() {
	return decodeZigZag32(this->readRawVarint32());
}


/** Read an {@code sint64} field value from the stream. */
int64_t CodedInputData::readSInt64() {
 ...
 */
int32_t CodedInputData::decodeZigZag32(int32_t n) {
 ...
 */
int64_t CodedInputData::decodeZigZag64(int64_t n) {
